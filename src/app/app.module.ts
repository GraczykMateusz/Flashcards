...
import {LoginFailedComponent} from './components/account/login/login-failed/login-failed.component';
import {RegisterFailedComponent} from './components/account/register/register-failed/register-failed.component';
...
import {FireErrorHandler} from './services/error/FireErrorHandler';
...
@NgModule({
  ...
  providers: [
    ...
    {provide: ErrorHandler, useClass: FireErrorHandler}
  ],
